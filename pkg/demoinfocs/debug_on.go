...
import (
	...
	msg "github.com/bugkingzht/cs-demobox/pkg/demoinfocs/msg"
...
// Can be overridden via -ldflags="-X 'github.com/bugkingzht/cs-demobox/pkg/demoinfocs.debugServerClasses=YES'"
// e.g. `go run -tags debugdemoinfocs -ldflags="-X 'github.com/bugkingzht/cs-demobox/pkg/demoinfocs.debugDemoCommands=YES'" ...`
